 ...
 * javax.servlet.http.HttpServletResponse#sendError(int, String) rsp.sendError()} so it'd be nice if
 * we could have the error message be whatever arguments get passed to {@code sendError}.
 *
