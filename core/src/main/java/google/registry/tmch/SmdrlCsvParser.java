 ...
 *
 * <p>This is a quick and dirty CSV parser made specifically for the SMDRL CSV format defined in the
...
public final class SmdrlCsvParser {
  ...
  public static SignedMarkRevocationList parse(List<String> lines) {
    ...
    checkArgument(
        "smd-id".equals(secondLine.get(0)),
        String.format("Line 2: Expected header \"smd-id\", found \"%s\"", secondLine.get(0)));
    checkArgument(
        "insertion-datetime".equals(secondLine.get(1)),
        String.format(
