...
public class DomainDeleteFlowCustomLogic extends BaseFlowCustomLogic {
   ...
   *
   * <p>This takes the {@link google.registry.model.eppoutput.Result.Code} and {@link
   * ResponseExtension}s as input and returns them, potentially with modifications.
   */
  @SuppressWarnings("unused")
